---
title: "Analysing Learner Speech and Resulting Applications for EFL Classrooms - A corpus-based contrastive analysis of vowel production of L1 English speakers and L1 Japanese learners of English (Part 1)"
...
This R Notebook shows the analysis of high front and back vowels produced by Japanese learners and L1 speakers of English. This notebook contains the first part of the analysis which focuses on data extraction and compilation. 
...
Schweinberger, Martin. `r format(Sys.time(), '%Y')`. Analysing Learner Speech and Resulting Applications for EFL Classrooms - A corpus-based contrastive analysis of vowel production of L1 English speakers and L1 Japanese learners of English (Part 1). Brisbane: The University of Queensland, School of Languages and Cultures. url: https://slcladal.github.io/praatrf.html (Version `r format(Sys.time(), '%Y.%m.%d')`).

@manual{schweinberger`r format(Sys.time(), '%Y')`japevk1,
